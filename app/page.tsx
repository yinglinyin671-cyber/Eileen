...
export default function Home() {
  ...
  return <main>
    ...
    <section className="manifesto reveal" id="about"><div className="section-tag">01 — PROFILE</div><p className="manifesto-copy">I translate inherited symbols<br />into <em>living languages</em> —<br />precise, warm, remembered.</p><div className="seal"><span>尹</span><small>YIN<br />YINGLIN</small></div></section>
